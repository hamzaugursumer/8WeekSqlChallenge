...
--Tablo 1: Planlar--
-- Müşteriler ilk kayıt olduklarında Foodie-Fi'ye hangi planlarla katılacaklarını seçebilirler.

-- Temel plan müşterilerinin sınırlı erişimi vardır ve yalnızca videolarını izleyebilirler ve yalnızca aylık 9,90 ABD doları karşılığında kullanılabilir.

-- Pro plan müşterilerinin izleme süresi sınırı yoktur ve çevrimdışı görüntüleme için videoları indirebilirler. 
-- Pro planlar aylık 19,90 ABD dolarından veya yıllık abonelik için 199 ABD dolarından başlıyor.

-- Müşteriler ilk 7 günlük ücretsiz denemeye kaydolabilir, deneme sırasında herhangi bir noktada iptal etmedikleri, 
-- temel plana düşürmedikleri veya yıllık profesyonel plana yükseltmedikleri sürece otomatik olarak profesyonel aylık abonelik planıyla devam ederler.

-- Müşteriler Foodie-Fi hizmetlerini iptal ettiklerinde - boş bir fiyatla bir churn plan kaydına sahip olacaklar, 
-- ancak planları fatura döneminin sonuna kadar devam edecek.

--******************************************--

--Tablo 2: Abonelikler--
-- Müşteri abonelikleri, belirli plan_id'lerinin başladığı tam tarihi gösterir.

-- Müşteriler profesyonel bir plandan daha düşük bir plana geçerse veya aboneliklerini iptal ederse daha yüksek plan 
-- dönem sona erene kadar yürürlükte kalacaktır abonelikler tablosundaki start_date, gerçek planın değiştiği tarihi yansıtacaktır.

-- Müşteriler hesaplarını temel plandan profesyonel veya yıllık profesyonel plana yükselttiklerinde, daha yüksek plan hemen yürürlüğe girecektir.

-- Müşteriler vazgeçtiklerinde - mevcut fatura dönemlerinin sonuna kadar erişimlerini koruyacaklar ancak başlangıç_tarihi teknik olarak hizmetlerini 
-- iptal etmeye karar verdikleri gün olacaktır.
